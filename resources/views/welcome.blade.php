...
<div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        <div class="flex justify-center">
            <img src="{{asset('images/logo-rakamin.png')}}">
        </div>
        ...
        <div class="mt-16">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                <a href="https://github.com/ikrar557/K3-Simple-Laravel-HW6" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                    <div>
                        <div class="h-16 w-16 bg-white-50 dark:bg-white flex items-center justify-center rounded-full">
                ...
                <div class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                    <div>
                        ...
                        <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                            ...
                            <li>Verifikasi email ke penerima langsung menggunakan relay email server.</li>
                            <li>Membuat nomor akun dan nomor kartu secara acak.</li>
                            <li>Membuat fitur "remember me".</li>

                        <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed"> Namun project ini memiliki kelemahan utama, yaitu <u>belum bisa nya adaptasi dengan tema terang/gelap dengan baik.</u></p>
